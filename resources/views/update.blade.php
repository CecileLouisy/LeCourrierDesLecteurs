...
<body>
    ...
    <form action="{{url('/update/'.$article->id)}}" method="POST">
        ...
        <div>
            ...
            value="{{old('zipcode',$article->zipcode)}}">
            @error('zipcode')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            <button type="submit" name="subFormCreate">Modifier cet article</button>
        </div>
    </form>
</body>
</html>